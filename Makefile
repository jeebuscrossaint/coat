...
APP_SRCS = $(SRC_DIR)/modules/bat.c $(SRC_DIR)/modules/btop.c $(SRC_DIR)/modules/conky.c \
           ...
           $(SRC_DIR)/modules/ranger.c $(SRC_DIR)/modules/rofi.c $(SRC_DIR)/modules/sway.c $(SRC_DIR)/modules/swaylock.c \
           $(SRC_DIR)/modules/tty.c $(SRC_DIR)/modules/vesktop.c $(SRC_DIR)/modules/vscode.c \
           $(SRC_DIR)/modules/waybar.c $(SRC_DIR)/modules/xresources.c $(SRC_DIR)/modules/yazi.c \
